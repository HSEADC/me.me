...
function M_SearchResult(_ref) {
  ...
  }, result.type, " \xB7 ", result.description));
}
...
function W_SearchContainer() {
  ...
  function handleSubmit(event) {
    ...
    window.location.href = "/me.me/search.html?q=".concat(encodeURIComponent(normalizedValue));
  }
