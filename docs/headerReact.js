...
;// ./src/components/A_HeaderLink.jsx
...
;// ./src/javascripts/search_data.js
var searchItems = [{
  title: "о нас",
...
function A_SearchInput(_ref) {
  var value = _ref.value,
    _onChange = _ref.onChange;
  return /*#__PURE__*/react.createElement("input", {
    type: "text",
    placeholder: "\u043D\u0430\u0439\u0442\u0438 \u043C\u0435\u043C \u043F\u0440\u043E...",
...
;// ./src/components/M_SearchResult.jsx

function M_SearchResult(_ref) {
  var result = _ref.result;
  return /*#__PURE__*/react.createElement("a", {
    className: "M_SearchResult",
    href: result.url
  }, /*#__PURE__*/react.createElement("h5", {
    className: "A_SearchResultHeader"
  }, result.title), /*#__PURE__*/react.createElement("p", {
    className: "A_SearchResultDescription"
  }, result.description));
}
;// ./src/components/C_Dropdown.jsx


function C_Dropdown(_ref) {
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    return /*#__PURE__*/react.createElement(M_SearchResult, {
      key: result.url,
      result: result
    });
  }));
}
;// ./src/components/W_SearchContainer.jsx
...
function W_SearchContainer() {
  var _useState = (0,react.useState)(""),
    _useState2 = _slicedToArray(_useState, 2),
    value = _useState2[0],
    setValue = _useState2[1];
  var normalizedValue = value.toLowerCase().trim();
  var results = normalizedValue.length < 2 ? [] : searchItems.filter(function (item) {
    var searchableText = [item.title, item.description, item.type].concat(_toConsumableArray(item.keywords || [])).join(" ").toLowerCase();
    return searchableText.includes(normalizedValue);
  });
  function handleSubmit(event) {
    event.preventDefault();
    if (normalizedValue.length < 2) return;
    window.location.href = "https://mememedia.adc.ac/search.html?q=".concat(encodeURIComponent(normalizedValue));
  }
  return /*#__PURE__*/react.createElement("form", {
    className: "W_SearchContainer",
...
if (header) {
  (0,client.createRoot)(header).render(/*#__PURE__*/react.createElement(M_Header, null));
}
/******/ })()
;